...
class example_1(Scene):
    def construct(self):
        ...
        arrow_1 = Arrow(start=[-1.7,2,0], end=[1.7,2,0], color=PINK, tip_shape=StealthTip)
        arrow_2 = Arrow(start=[-1.7,-0.5,0], end=[1.7,-0.5,0], color=PINK, tip_shape=StealthTip)
        ...
        self.wait(2)
        self.play(LaggedStart(Transform(m0,m20), Transform(m1, m21), Transform(eq1, eq3), run_time=2))
        self.wait(4)
...
class example_2(Scene):
    def construct(self):
        ...
        arrow_1 = LabeledArrow(start=[-1.7,1.5,0], end=[1.7,1.5,0], color=PINK, tip_shape=StealthTip, label=eq1)
        arrow_2 = LabeledArrow(start=[1.7,0.5,0], end=[-1.7,-1.5,0], color=PINK, tip_shape=StealthTip, label=eq2)
        arrow_3 = LabeledArrow(start=[-1.7,-2.5,0], end=[1.7,-2.5,0], color=PINK, tip_shape=StealthTip, label=eq3)
        ...
        self.play(ShowCreationThenFadeOut(b1))
        self.play(ShowCreationThenFadeOut(b2))
        self.wait(1)
